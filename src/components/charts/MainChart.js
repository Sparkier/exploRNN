...
class MainChart extends React.Component {
    ...
    createChart = () => {
      ...
      const width = this.chartWidth - margin.left - margin.right; // Use the window's width
      const height = this.chartHeight - margin.top - margin.bottom; // Use the window's height
